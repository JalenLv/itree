...
EXTERN_DIR=extern
CJSON_DIR=$(EXTERN_DIR)/cJSON
CJSON_INC_DIR=$(CJSON_DIR)/include
CJSON_SRC=$(wildcard $(CJSON_DIR)/src/*.c)

CFLAGS=-Wall -Wextra -O3 \
	-I$(INCLUDE_DIR) -I$(CJSON_INC_DIR)
...
itree: $(SRC) $(CJSON_SRC)
	gcc $(CFLAGS) $(SRC) $(CJSON_SRC) -o itree -lncurses

# main.o: $(SRC_DIR)/main.c
# 	gcc $(CFLAGS) -c $(SRC_DIR)/main.c -I$(INCLUDE_DIR) -I$(CJSON_INC_DIR) -o main.o
