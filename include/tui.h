...
typedef struct {
    ...
    size_t visible_entries_head;   // Index of the first visible entry (inclusive)
    size_t visible_entries_tail;   // Index of next entry of the last visible entry (exclusive)
